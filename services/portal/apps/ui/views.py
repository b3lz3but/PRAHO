...
STAT_TILE_SAMPLES = [
    ...
    {"label": "Open Tickets", "value": "3", "icon": "bell", "variant": "info"},
    {"label": "Domains", "value": "7", "icon": "domain", "variant": "default"},
]
...
TABLE_HEADERS = ["Service", "Plan", "Status", "Price"]
TABLE_ROWS = [
    ["Web Hosting", "Basic", "active", "39 RON"],
    ["VPS Pro", "Standard", "active", "149 RON"],
    ["Email Business", "Pro", "pending", "19 RON"],
]
